//Desclaracion de la clase para los personajes
class Coche {
...
let coche2 = new Coche("Kart", "luigi", 195, 1990, 45);
let coche3 = new Coche("Kart", "wario", 230, 2300, 70);
let coche4 = new Coche("Kart", "waluigi", 200, 1950, 40);
let coche5 = new Coche("Kart", "peach", 200, 1900, 70);
let coche6 = new Coche("Kart", "estela", 200, 1900, 70);
let coche7 = new Coche("Kart", "bowser", 250, 2500, 90);
